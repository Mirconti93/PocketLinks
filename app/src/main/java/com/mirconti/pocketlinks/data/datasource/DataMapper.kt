...
class DataMapper {
    companion object {
        fun entityFromPlayerModel(player: CategoryModel) : Player {
            return Player(
                name = player.name,
        ...
        fun playerModelFromEntity(player: Player) : CategoryModel {
        ...
        fun teamModelFromEntity(team: Team) : LinkModel {
            return LinkModel(
                name = team.name,
                city = team.city,
        ...
        fun entityFromTeamModel(team: LinkModel) : Team {
            return Team(
                name = team.name,
                city = team.city,
                country = team.country,
        ...
        fun playerMatchFromPlayer(player: CategoryModel): PlayerMatchModel {
